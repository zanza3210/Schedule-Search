...
public class How extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("\n\n\nโปรแกรม Smart Schedule.\n\n\n   เป็นโปรแกรมที่ใช้ในการออกแบบตารางสอบโดยคณะผู้จัดทำเล็งเห็น\nปัญหาที่เกิดจากการค้นหารายวิชาที่สอบฉะนั้นคณะผู้จัดทำจึงจัดทำโปรแกรม\nนี้ขึ้นเพื่อที่จะอำนวยความสะดวกให้แก่ผู้ใช้งานถ้าผิดพลาดประการใดต้องขอ\nอภัยมา ณ ที่นี้ด้วย\n\n\n\n\t\t\t\tคณะผู้จัดทำ");
